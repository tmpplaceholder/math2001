...
example {x y : ℝ} (h1 : x + y = 4) (h2 : 5 * x - 3 * y = 4) : x = 2 :=
  calc x = (3 * (x + y) + (5 * x - 3 * y)) / 8 := by ring
...
example {z : ℝ} (h1 : z ^ 2 - 2 = 0) : z ^ 4 - z ^ 3 - z ^ 2 + 2 * z + 1 = 3 :=
  calc z ^ 4 - z ^ 3 - z ^ 2 + 2 * z + 1 = (z ^ 2 - z + 1) * (z ^ 2 -2) + 3 := by ring
...
example {t : ℚ} (ht : t ^ 2 - 4 = 0) :
  ...
  calc t ^ 4 + 3 * t ^ 3 - 3 * t ^ 2 - 2 * t - 2 = (t ^ 2 + 3 * t + 1) * (t ^ 2 - 4) + 10 * t + 2 := by ring
    _ = (t ^ 2 + 3 * t + 1) * 0 + 10 * t + 2 := by rw [ht]
    _ = 10 * t + 2 := by ring

example {x y : ℝ} (h1 : x + 3 = 5) (h2 : 2 * x - y * x = 0) : y = 2 :=
  calc y = 5 * y / 2 - (x + 3) * y / 2 + (x + 3) - (2 * x - y * x) / 2 - 3 := by ring
    _ = 5 * y / 2 - 5 * y / 2 + 5 - 0 / 2 - 3 := by rw [h1, h2]
    _ = 2 := by ring
